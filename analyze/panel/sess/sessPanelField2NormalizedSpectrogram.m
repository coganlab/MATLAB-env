function Data = sessPanelField2NormalizedSpectrogram(Sess,CondParams, AnalParams)
%
%   Data = sessField2NormalizedSpectrogram(Sess,CondParams,AnalParams)
%
...
if length(Trials{1}) > 3
    ...
    numtrials = 0;
    f = linspace(0,fk,200); t = bn(1):dn*1e3:bn(2);
