function Data = sessPanelDecimateSpikeRate(Sess, CondParams, AnalParams)
%
%   Data = sessPanelDecimateSpikeRate(Sess, CondParams, AnalParams)
%
%   Decimates Firing and shows PSTH      
%
