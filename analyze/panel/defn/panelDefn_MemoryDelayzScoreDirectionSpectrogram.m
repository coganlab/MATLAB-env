...
CondParams(1,1).Name = ['MemoryDelay' SessType 'zScoreDirectionSpectrogram']; 
CondParams(1,1).Task = {{'MemoryReachSaccade','DelReachSaccade'}};
CondParams(1,1).conds = {[Dirs(1)]};
CondNorm.Task = {{'MemoryReachSaccade','DelReachSaccade'}};
...
CondNorm.Task = {{'MemorySaccadeTouch','DelSaccadeTouch'}};
CondNorm.Cond = {[Dirs(2)]};
CondParams(1,1).Norm = CondNorm;
