...
CondParams(1,1).Name = 'Local_Distant_NullzScoreCoherogram';
...
AnalParams(1,2).Type = 'NullzScoreCoherogram';
...
AnalParams(1,3).Type = 'NullzScoreCoherogram';
...
AnalParams(2,1).Type = 'NullzScoreCoherogram';
...
AnalParams(2,2).Type = 'NullzScoreCoherogram';
...
AnalParams(2,3).Type = 'NullzScoreCoherogram';
