...
CondParams(1,1).Name = ['MemoryDelay' SessType 'zScoreDifferentialDirectionSpectrogram']; 
CondParams(1,1).Task = {{'MemoryReachSaccade','DelReachSaccade'}};
CondParams(1,1).conds = {[Dirs(1)]};
CondDiff.Task = {{'MemoryReachSaccade','DelReachSaccade'}};
...
CondNorm.Task = {{'MemorySaccadeTouch','DelSaccadeTouch','DelSaccade'}};
