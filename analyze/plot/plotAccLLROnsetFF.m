function plotAccLLROnsetFF(Results)
%
%  plotAccLLROnsetFF(Results)
%

%  Plot AccLLRFF
%figure;
%Lfp1HitDir1 = find(~isnan(Results.NoHist.Event.OnsetTimesF1));
%Lfp1NoneDir1 = find(isnan(Results.NoHist.Event.OnsetTimesF1) & ...
...
%
%  Plot field-field Onset Time correlations

% Times for Dir1
ind = find(~isnan(Results.NoHist.Event.OnsetTimesF1) & ...
    ~isnan(Results.NoHist.Event.OnsetTimesF2));

Field1ST = [Results.NoHist.Event.OnsetTimesF1(ind)];

Field2ST = [Results.NoHist.Event.OnsetTimesF2(ind)];
