...
switch TaskCode
  case {0,1,2,3,4,5,6,7,8,11,12,16,17,24,26,27,28,29,30,32,33,39,40,42}  %  No visually-guided reach
    flag = 0;
  case {9,10,13,14,15,18,19,20,21,22,23,25,31,34,35,36,37,38,41,43,44}  %  Reach
    flag = 1;
end
