function [Opt_p, Opt_ST, Opt_FA, Con_p, Con_ST, Con_FA] = calcSelectionTrialAveragePerformance(Onset, FA, DetectType,MinST, pCorr)
%
...
%           pCorr= Probability of correct to match
...
for iNumTrials = 1:length(NumTrials)
    ...
    [Con_p(iNumTrials), Con_ST(iNumTrials), Con_FA(iNumTrials)] = ...
        controlled_performance(p, ST, FA, DetectType, MinST,pCorr);
end
