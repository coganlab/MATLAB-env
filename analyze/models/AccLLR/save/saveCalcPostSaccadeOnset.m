function saveCalcPostSaccadeOnset(Session, Params, OverwriteFlag)
%
...
if nargin < 2
  ...
  Params.Task = 'MemorySaccadeTouch';
...
Params.Null.Task = 'MemoryReachSaccade';
Params.Null.Target = [];
Params.Null.Field = 'SaccStart'; 
