...
switch InputParams.Type
  case 'Visual'
    load([MONKEYDIR '/mat/' SessionType '/' SessionType '_' InputParams.Selection 'Onset.' InputParams.Type '.' ...
      TaskString '.Dir' num2str(InputParams.Event.Target) '.' SessNumString InputParams.Label '.mat']);
%     DetectType = 'Hit';
    Onset = DecisionOnset;
  case 'Choice'
    load([MONKEYDIR '/mat/' SessionType '/' SessionType '_' InputParams.Selection 'Onset.' InputParams.Type '.' ...
      TaskString '.' SessNumString InputParams.Label '.mat']);
%     DetectType = 'Correct';
    Onset = DecisionOnset;
end
