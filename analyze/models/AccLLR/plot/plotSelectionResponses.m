...
MaxTime = Params.MaximumTimetoOnsetDetection - Params.StartofAccumulationTime;
Go = Params.StartofAccumulationTime - Params.StartTime;
...
for iType = 1:length(Onset.Results)
    ...
    Start =  Params.StartofAccumulationTime;
    Stop = Params.MaximumTimetoOnsetDetection;
    tEvent = Start+1:Stop;
