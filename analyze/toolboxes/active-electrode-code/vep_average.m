...
function [avg_eps,count,x] = vep_average(data, start_sec, stop_sec, SecsPre, SecsPost, numRow, Fs, data_type, x_chan, number_x_levels, invert_x, y_chan, number_y_levels, invert_y, ttl_chan, trigger_edge, ttl_threshold, level_set_delay)
