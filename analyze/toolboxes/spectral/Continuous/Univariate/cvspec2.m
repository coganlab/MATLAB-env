function [Err, P] = cvspec2(X, Ntrial, nIter, prange, sampling, fk, pad);
%CVSPEC2  Cross-validated spectrum estimate using multitaper techniques.
%
%	This is different from CVSPEC.  It uses the density estimation 
%
