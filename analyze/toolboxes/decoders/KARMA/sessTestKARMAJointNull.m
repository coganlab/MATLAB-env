function Results = sessTestKARMAJointNull(Session, Tower, JointList, karmaparams, bin_time);
%
%  Results = sessTestKARMAJointNull(Session, Tower, JointList)
%
...
for iJoint = 1:size(jointPos,2)
    randomized_ind = randperm(size(jointPos,1));
    jointPos(:,iJoint) = jointPos(randomized_ind,iJoint);
end
