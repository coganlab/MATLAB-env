function times = bench_nographics(count)
%BENCH  MATLAB R2012a Benchmark
...
if exist('bench_R2012a.dat','file') ~= 2
    warning(message('MATLAB:bench:noDataFileFound'))
    return
end
fp = fopen('bench_R2012a.dat', 'rt');
...
y = A\b; % Preallocate y
tic
y = A\b; % Result not used -- strictly for timing
t = toc;
end
% ----------------------------------------------- %
