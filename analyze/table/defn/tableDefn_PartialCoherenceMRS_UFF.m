...
Table.Quantity(27).Name = 'NullCohF1_Unit';
Table.Quantity(28).Name = 'NullCohF2_Unit';
Table.Quantity(29).Name = 'NullCohF1_F2';
Table.Quantity(30).Name = 'NullPartialCoh';
...
Table.Quantity(45).Name = 'PrefSigDiffCoh21v31';
Table.Quantity(46).Name = 'SpikeWaveform_tophalf';
Table.Quantity(47).Name = 'WaveformSNR';
Table.Quantity(48).Name = 'Monkey';
Table.Quantity(49).Name = 'TunedUnitpostGo';
Table.Quantity(50).Name = 'TunedField1postGo'; 
Table.Quantity(51).Name = 'TunedField2postGo'; 
...
Table.Quantity(45).Type = 'PrefSigDiffCoh21v31';
Table.Quantity(46).Type = 'SpikeWaveformS1';
Table.Quantity(47).Type = 'WaveformSNRS1';
Table.Quantity(48).Type = 'Monkey';
Table.Quantity(49).Type = 'TunedUnitS1';
Table.Quantity(50).Type = 'TunedFieldS2'; 
Table.Quantity(51).Type = 'TunedFieldS3'; 
...
for iSess = 1:length(Table.Data.Sessions)
    ...
    Table.Quantity(49).CondParams{iSess} = CondParams1; %'TunedUnitpostGo'
    Table.Quantity(49).AnalParams{iSess} = AnalParams1;
    Table.Quantity(50).CondParams{iSess} = CondParams1; %'TunedField1postGo'
    Table.Quantity(50).AnalParams{iSess} = AnalParams1;
    Table.Quantity(51).CondParams{iSess} = CondParams1; %'TunedFieldpostGo'
    ...
    Table.Quantity(46).CondParams{iSess} = CondParams1;
    Table.Quantity(46).AnalParams{iSess} = [];
