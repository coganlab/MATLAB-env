function saveCalcDecisionChoiceOnset(Session, Params, OverwriteFlag,filename,decimate)
%
% saveCalcDecisionChoiceOnset(Session, Params, OverwriteFlag,decimate)
%
...
if iscell(Session{1})
    ...
    Filename = [MONKEYDIR '/mat/' SessionType '/' SessionType '_' Params.Selection 'Onset.' Params.Type '.' ...
        TaskString '.' SessionLabelString Params.Label '.mat'];
end
if(file)
    Filename = filename;
end
...
if FileFlag && ~OverwriteFlag
    ...
    switch SessionType
        case 'Spike'
            [Results,Data,Model] = loocalcDecisionOnsetS(Session,Params,decimate);
        case 'Field'
