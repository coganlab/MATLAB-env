function [Results, Data , Model] = loocalcDecisionOnsetFF(Session, InputParams)
%
%  [Results, Data, Model] = loocalcDecisionOnsetFF(Session, InputParams);
...
if NoHistFlag
    %  Processing the Lfp and LFP No History models
    ...
    if TrialAvgdFlag
        ...
        Lfp1_TrialAv = likTrialAvLfpNoHistModel(Lfp1Event, Lfp1Null, ...
            InputParams);
        Lfp2_TrialAv = likTrialAvLfpNoHistModel(Lfp2Event, Lfp2Null, ...
            InputParams);
