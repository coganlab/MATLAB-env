...
%     keyboard
    ...
    if ~isempty(events)
        ...
        Events.ContinuousTarget1 = zeros(ntr,1);
        Events.ContinuousTarget2 = zeros(ntr,1);
        Events.ContinuousRadius1= zeros(ntr,1);
        Events.ContinuousRadius2 = zeros(ntr,1);
        Events.ContinuousTarget1Cood = zeros(ntr,2);
        Events.ContinuousTarget2Cood = zeros(ntr,2);
