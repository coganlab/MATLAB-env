...
%             register_KeyPressFcn(o.h_fig, 'WindowScrollWheelFcn',  @o.Scroll)
%             register_KeyPressFcn(o.h_fig, 'WindowButtonDownFcn',   @o.ButtonDown)
%             register_KeyPressFcn(o.h_fig, 'WindowButtonUpFcn',     @o.ButtonUp)
%             register_KeyPressFcn(o.h_fig, 'WindowButtonMotionFcn', @o.Motion);
