...
lh_rightmost_point = max(left_mesh.vert(:,1));
rh_leftmost_point = min(right_mesh.vert(:,1));

left_mesh.vert(:,1) = left_mesh.vert(:,1) - lh_rightmost_point - distance/2;
right_mesh.vert(:,1) = right_mesh.vert(:,1) - rh_leftmost_point + distance/2;
