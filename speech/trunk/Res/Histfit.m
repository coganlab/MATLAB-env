% HISTFIT:  Fit a continuous function to a histogram using Pearson functions.
%           Returns the pdf as a set of 100 coordinates.
%
%     Usage: crds = histfit(midpoints,freqs,{relative},{noplot})
%                     OR
%            crds = histfit(x,{nbins},{relative},{noplot})
%
...
function crds = histfit(x,freqs,relative,noplot)
