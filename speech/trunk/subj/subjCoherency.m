function [Coh, Spec1, Spec2, Data, myTrials] = subjCoherency(Subject, CondParams, AnalParams)
%
    ...
    case 'Grand average'
        ...
        if size(Ch,1)>1
            ...
            for iChPair = 1:size(Ch,1)
                ...
                [Coh{iChPair}, f, Spec1, Spec2] = tfcoh(gIEEG1,gIEEG2,tapers,sampling,dn,fk,pad,[],flag);
                display('Right')
                %toc
            end
            Data = [];
