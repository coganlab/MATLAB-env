function [iiLSSA iiJLSA iiLSSP iiJLSP sigMatLSSA sigMatJLSA sigMatLSSP sigMatJLSP]=convertActClusttoIdxSentence(actClustLSA,actClustJLA,actClustLSP,actClustJLP,zVal)
