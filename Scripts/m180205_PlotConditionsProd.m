...
for iChan=1:60
    ...
    for iCond=1:4
        ...
        baseline_chansM{iChan}{iCond}=mean(mean(Auditory_Spec{iCond}{iChan2}(:,1:10,freqRange),2),1);
...
for iChan=1:60
    ...
    for iCond=1:4
        hold on;
    tmp=sq(mean(Motor_Spec{iCond}{iChan2}(:,:,freqRange)./repmat(baseline_chansM{iChan}{iCond},size(Motor_Spec{iCond}{iChan2},1),size(Motor_Spec{iCond}{iChan2},2),1),3));
...
for iChan=1:60
    ...
    for iCond=1:2
    hold on;
    tmp1=sq(mean(Motor_Spec{iCond}{iChan2}(:,:,freqRange)./repmat(baseline_chansM{iChan}{iCond},size(Motor_Spec{iCond}{iChan2},1),size(Motor_Spec{iCond}{iChan2},2),1),3));
    tmp2=sq(mean(Motor_Spec{iCond+2}{iChan2}(:,:,freqRange)./repmat(baseline_chansM{iChan}{iCond+2},size(Motor_Spec{iCond+2}{iChan2},1),size(Motor_Spec{iCond+2}{iChan2},2),1),3));
...
for iChan=1:60
    ...
    for iCond=1:2
    hold on;
    tmp1=sq(mean(Motor_Spec{2*iCond-1}{iChan2}(:,:,freqRange)./repmat(baseline_chansM{iChan}{2*iCond-1},size(Motor_Spec{2*iCond-1}{iChan2},1),size(Motor_Spec{2*iCond-1}{iChan2},2),1),3));
    tmp2=sq(mean(Motor_Spec{2*iCond}{iChan2}(:,:,freqRange)./repmat(baseline_chansM{iChan}{2*iCond},size(Motor_Spec{2*iCond}{iChan2},1),size(Motor_Spec{2*iCond}{iChan2},2),1),3));
