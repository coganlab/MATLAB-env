function preProcess_Specgrams(Task, Subject, fileType)
arguments
    Task
    Subject
    fileType = 'png'
...
if ~isfield(Task,'Fig')
    ...
    elseif strcmp(Task.Name,'SentenceRep')
        ...
        Task.Fig.Field(1).Time=[-500 1000]; %[0 500];
        ...
        for iF=1:length(Task.Fig.Field)
            ...
            for iG=0:totChanBlock-1;
                ...
                if strcmp(fileType, 'eps')
                    saveas(FigS,[DUKEDIR '/Figs/' Subject(SN).Name '/' Subject(SN).Name '_' Task.Name '_' Task.Fig.Field(iF).Name '_SpecGrams_200Hz_0.7to1.2C_' num2str(iG+1) '.' fileType],'epsc')
                else
                    saveas(FigS,[DUKEDIR '/Figs/' Subject(SN).Name '/' Subject(SN).Name '_' Task.Name '_' Task.Fig.Field(iF).Name '_SpecGrams_200Hz_0.7to1.2C_' num2str(iG+1) '.' fileType])% '.eps'],'epsc')
                end
            ...
            for iG=0:totChanBlock-1;
                ...
                if strcmp(fileType, 'eps')
                    saveas(FigS,[DUKEDIR '/Figs/' Subject(SN).Name '/' Subject(SN).Name '_' Task.Name '_' Task.Fig.Field(iF).Name '_SpecGrams_200Hz_0.7to1.4C_' num2str(iG+1) '.' fileType],'epsc')
                else
                    saveas(FigS,[DUKEDIR '/Figs/' Subject(SN).Name '/' Subject(SN).Name '_' Task.Name '_' Task.Fig.Field(iF).Name '_SpecGrams_200Hz_0.7to1.4C_' num2str(iG+1) '.' fileType])
                end
                %  imwrite(F.cdata,[DUKEDIR '/Figs/' Subject(SN).Name '/' Subject(SN).Name '_NeighborhoodSternberg_Auditory_SpecGrams_200Hz_0.7to1.4C_' num2str(iF+1) '.png'],'png');
                close
            end
