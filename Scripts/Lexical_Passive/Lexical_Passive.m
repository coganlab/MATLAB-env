function Lexical_Passive(subject,practice)
...
%subject = 'Test2';
subjecDir = ['C:\Psychtoolbox_Scripts\Lexical_Passive\' subject];
soundDirW = 'C:\Psychtoolbox_Scripts\Lexical_Passive\stim\words\';
soundDirNW= 'C:\Psychtoolbox_Scripts\Lexical_Passive\stim\nonwords\';
nBlocks = 4
trialCount=0;
blockCount=0;
trialEnd=42; %54
...
% trialorder
trialOrderWordsOrig=1:84;
trialOrderNonWordsOrig=1:84;
