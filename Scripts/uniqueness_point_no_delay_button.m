...
% %% Manipulations
sca;
playbackdevID = 3; % 3 if no usb speaker 3, otherwise, 4
capturedevID = 1;
% number of blocks
nBlocks = 4; 
% block start
...
soundDirW4 = 'C:\Psychtoolbox_Scripts\uniqueness_point\stim\w4\';
soundDirW7 = 'C:\Psychtoolbox_Scripts\uniqueness_point\stim\w7\';
soundDirNW4= 'C:\Psychtoolbox_Scripts\uniqueness_point\stim\nw4\';
soundDirNW7= 'C:\Psychtoolbox_Scripts\uniqueness_point\stim\nw7\';
% Sound setup
nrchannels = 1;
freqS = 44100;
freqR = 20000;
...
if startblock==1
    ...
    save(['C:\Psychtoolbox_Scripts\uniqueness_point\' subject '_trialOrderAll_Shuffle.mat'],'trialOrderAll_Shuffle');
elseif startblock>1
    load(['C:\Psychtoolbox_Scripts\uniqueness_point\' subject '_trialOrderAll_Shuffle.mat']);
end
...
acceptedKeys = [YesKey, NoKey, spaceKey, escapeKey]; % accepted keys for response
...
Priority(2);
 [sound fs]=audioread('C:/Psychtoolbox_Scripts/Lexical_Repeat/blank.wav');
...
for iB=iBStart:nBlocks
    ...
    % play tone!
    tone500=audioread('C:\Psychtoolbox_Scripts\Lexical_Repeat\stim\tone500_3.wav');
   % tone500=.5*tone500;
    pahandle = PsychPortAudio('Open', playbackdevID, 1, 2, freqS, nrchannels,0, 0.015);
