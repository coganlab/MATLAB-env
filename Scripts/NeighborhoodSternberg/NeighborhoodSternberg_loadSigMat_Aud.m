...
for iSN=1:length(SNList);
    SN=SNList(iSN);
  %  load([DUKEDIR '\Output\' Subject(SN).Name '_NeighborhoodSternberg_ClusterTime_5FreqBands_2Tails.mat']);
    load([DUKEDIR '/Output/' Subject(SN).Name '_NeighborhoodSternberg_ClusterTime_5FreqBands_2Tails_AuditoryCollapse.mat']);
