...
save([DUKEDIR '/Output/' Subject(SN).Name '_NeighborhoodSternberg_ClusterTime_5FreqBands_2Tails_bw6_noShuff.mat'],'zValsRaw*','pValsRaw*','actClust*','freqBand','AnalParams','behaviorMat','period');
clear zValsRaw*
clear pValsRaw*
clear actClust*
end
