function saveCalcDecisionVisualOnset(Session, Params, OverwriteFlag)
%
...
Params.Event.Target = [Params.Event.Target Params.Null.Target];
...
if iscell(Session{1})
    ...
    Filename = [MONKEYDIR '/mat/' SessionType '/' SessionType '_' Params.Selection 'Onset.' Params.Type '.' ...
        TaskString '.Dir' num2str(Params.Event.Target(1)) '.' SessionLabelString '.mat'];
end
