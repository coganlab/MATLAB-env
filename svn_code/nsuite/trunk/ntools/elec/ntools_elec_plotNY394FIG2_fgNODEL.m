...
for i=1:length(elec)
  ...
  if i==8 || i==14 || i==15 || i==20 || i==21 || i==22 || i==24 || i==30 % AUD
    ...
    elseif i==27 || i==29 || i == 34 ||i==36 || i==38 || i==42 || i==55 % PROD
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
   ...
   %     display(i) % removed bad channels
    ...
    elseif i==37 || i==53  % SM delay
            plot3(elec(i,1),elec(i,2),elec(i,3),['y' 'o'],'MarkerFaceColor','y','MarkerSize',markblackdelay);
             hold on;
         plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize);
    elseif i==39 || i==40 || i==41 || i==45 || i==46 || i==51 || i==52 || i==57 || i==58 || i==61 || i==62%ismember(i,misschans)
        display(i)
    else
