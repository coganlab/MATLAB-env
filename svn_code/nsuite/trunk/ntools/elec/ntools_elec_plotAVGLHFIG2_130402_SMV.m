...
% end
load('/mnt/raid/nim1_backup/nim1-raid-backup/NYUMC/LHSUBJ_130724/ALLELECS_LH.mat');
...
Alist=[1,2,3,4,8,10,11,14,17,18,21,22,23,25];
SMVlist=setdiff(1:26,Alist);
...
%        end
   ...
   for i=86:111 % SMA
       ...
       if i==81
        ...
        hold on;
    plot3((elec(i,1)),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblackSMA);
      hold on
         plot3((elec(i,1)),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',13);
   end
%    
end
