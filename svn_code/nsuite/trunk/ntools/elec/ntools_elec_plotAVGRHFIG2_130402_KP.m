...
%   if i==105 || i==106 || i==107 || i==110 || i==111 || i==112 || i==113 
   ...
   hold on;
    plot3((elec(i,1)+20),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblackSMA);
      hold on
         plot3((elec(i,1)+20),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',13);
   end
% %    
 end
