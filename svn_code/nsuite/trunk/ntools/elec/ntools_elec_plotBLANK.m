function ntools_elec_plotBLANK(varargin)
...
sph='rh';
 surf = '/vol/sas5a/nim1/NYUMC/RHSUBJ_130316/loc/RH.AVG.rh.pial.mat';
...
filename=['/vol/sas5a/nim1/NYUMC/NY149/mri/transforms/talairach.xfm'];
...
elec_grid = elec_cell(g,:);
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY192/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
filename=['/vol/sas5a/nim1/NYUMC/NY311/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elec_grid = elec_cell(g,:);
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY313/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elec_grid = elec_cell(g,:);
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY255v2/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY346/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elec_grid = elec_cell(g,:);
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY359/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY329/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY334/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
elecT=cell2mat(elec_grid(:,2:4));
filename=['/vol/sas5a/nim1/NYUMC/NY273/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
