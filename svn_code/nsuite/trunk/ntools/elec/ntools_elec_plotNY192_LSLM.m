...
if i==4 || i==6 || i==8 || i==12 || i==13 || i==26 || i==34 || i==35 || i==45 || i==51 || i==52 || i==54 || i==55 || i==56 || i==58 || i==59 || i==61 % LS
    plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
    hold on;
    plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',marksize);
    %    elseif i==17 || i==42 % LM
    %        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
    %         hold on;
    %           plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor','y','MarkerFaceColor','y','MarkerSize',marksize);
elseif i==7 || i==14 || i==15 || i==21 || i==28 || i==29 || i==30 || i==39 || i==42 % PROD
    plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
    hold on;
...
elseif i==1 || i ==2 || i ==45 || i==46 || i==47 || i ==63 || i==64
    display(i)
else
