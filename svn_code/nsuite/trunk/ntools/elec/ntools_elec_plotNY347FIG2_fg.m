...
for i=1:length(elec)
    ...
    elseif i==15 || i==18 || i==23 || i==37 || i==38 % PROD
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
        if i==15
            plot3(elec(i,1),elec(i,2),elec(i,3),['y' 'o'],'MarkerFaceColor','k','MarkerSize',markblackdelay);
   ...
   elseif i==50  % DEL
    ...
    elseif i==3 || i==4 || i==5 || i==7 || i ==8 || i==9 || i==10 || i==13 || i==14 || i==19 || i==20 || i==25 || i==26 || i==51 || i==52 || i==61 || i==62
        display(i)
    else
