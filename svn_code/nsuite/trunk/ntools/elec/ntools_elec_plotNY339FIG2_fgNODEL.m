...
for i=1:length(elec)
    ...
    if i==37 % AUD Delay
        plot3(elec(i,1),elec(i,2),elec(i,3),['y' 'o'],'MarkerFaceColor','y','MarkerSize',markblackdelay);
        hold on;
    ...
    elseif i==16 || i==21 || i == 107 % PROD
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
         plot3(elec(i,1),elec(i,2),elec(i,3),['b' 'o'],'MarkerFaceColor','b','MarkerSize',marksize);
    elseif i==15 ||  i==22 || i==82 % PROD delay
            plot3(elec(i,1),elec(i,2),elec(i,3),['y' 'o'],'MarkerFaceColor','y','MarkerSize',markblackdelay);
             hold on;
         plot3(elec(i,1),elec(i,2),elec(i,3),['b' 'o'],'MarkerFaceColor','b','MarkerSize',marksize);
