function ntools_elec_plotAVG_RH_KIGPOB_APSMANDAPSMDELAY_140302
...
%             %     hold on;
%             %     plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize);
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['m' 'o'],'MarkerFaceColor','m','MarkerSize',markblackdelay);
%             hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['m' 'o'],'MarkerFaceColor','m','MarkerSize',marksize);
%         end
    end
