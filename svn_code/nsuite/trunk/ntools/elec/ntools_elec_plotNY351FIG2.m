...
markblackSMA=80;
for i=1:length(elec)
    if i==34 || i==36 || i==37 || i==38 || i==46 || i==47 || i==48  %AUD
    ...
    elseif i==3 || i==4 || i==7 || i==8 || i ==9 || i==10 || i==13 || i==14 || i==19 || i==20 || i==23 || i==24 || i==29 || i==30 || i==49 || i==50 || i==51 || i==52 || i==53 || i==57 || i==58 || i==59 || i==60 || i==61 || i==62 || i==64
        display(i)
    else
