...
elec2(:,1)=elec2(:,1)+25; % -25 is LH, +25 is RH
...
for i=1:length(elec)
    ...
    elseif i==40  % PROD
         plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','b','MarkerSize',marksize,'LineWidth',1);
       % hold on;
       %   plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0.1 0.1 1],'MarkerFaceColor',[0.1 0.1 1],'MarkerSize',marksize);
    elseif i==19  % SM and AUD
        elec(i,1)=elec(i,1)+10;
         plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',1);
      %  hold on;
...
%      elseif i==17 || i==18  % SM no AUD
%          % plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize);
%                    plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',7);

%     elseif i==33 || i==34 || i==59 || i==60 || i==63 || i==64
%         display(i)
    else
    %plot3(elec(i,1),elec(i,2),elec(i,3),[color 'o'],'MarkerFaceColor',color,'MarkerSize',marksize);
             plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0.9 0.9 0.9],'MarkerFaceColor',[0.9 0.9 0.9],'MarkerSize',30);

    end
    if label==1
        text('Position',[elec(i,1) elec(i,2) elec(i,3)],'String',elecname(i,:),'Color','k');
    end
end
set(light,'Position',[-1 0 1]); 
    if strcmp(sph,'lh')
