...
%   if i==105 || i==106 || i==107 || i==110 || i==111 || i==112 || i==113 
   ...
   hold on;
    plot3((elec(i,1)+20),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
      hold on
       plot3(elec(i,1)+20,elec(i,2),elec(i,3),['r' 'o'],'MarkerEdgeColor',[1 0.1 0.1],'MarkerFaceColor',[1 0.1 0.1],'MarkerSize',marksize);
