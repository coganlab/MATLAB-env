...
for i=1:length(elec)
   % if i ==20
    %    plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize); % token AUD
    if i==28
   % if i==14  || i==20 ||i ==21 || i==22 || i==28 || i==50 || i==51 || i==56 || i==57 % AUD
...
%     elseif i==30 || i==32 || i==33 || i==34 || i==35 || i==37 || i==40 || i==41 || i==42 || i==43 || i==45 || i==46 || i==52 || i==53 || i==55 || i==60 || i==62  % PROD
%           plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%         hold on; 
%         plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0.1 0.1 1],'MarkerFaceColor',[0.1 0.1 1],'MarkerSize',marksize);
%     elseif i==13 || i==25 || i==36 || i==44 || i==54 || i==61  % SM & AUD
...
%         display(i)
    ...
    %plot3(elec(i,1),elec(i,2),elec(i,3),['w' 'o'],'MarkerFaceColor',color,'MarkerSize',marksize);
