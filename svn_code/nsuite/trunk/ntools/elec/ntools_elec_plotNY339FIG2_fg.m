...
axis off
hold on;
misschans1=[3,4,7,8,9,10,13,14,19,20,23,24,25,26,29,30,35,36,39,40,41,42,45,46,51,52,55,56,57,58,61,62];
misschans2=misschans1+64;
misschans=cat(2,misschans1,misschans2);
for i=1:length(elec)
    ...
    elseif i==12 || i==15 || i==16 || i==21 || i==22 || i==102 % PROD
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
        if i==15 || i==102
            plot3(elec(i,1),elec(i,2),elec(i,3),['y' 'o'],'MarkerFaceColor','k','MarkerSize',markblackdelay);
