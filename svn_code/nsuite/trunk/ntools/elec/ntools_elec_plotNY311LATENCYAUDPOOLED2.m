...
nyumc;
load([NYUMCDIR '/NY311/mat/NY311AUDRANKS.mat']);
iAUDRANK=find(AUDRANK>0);
...
% %           plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize);
    elseif i==13 || i==25 || i==36 || i==44 || i==54 || i==61    % SM and AUd
...
%          plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0.9 0.9 0.9],'MarkerFaceColor',[0.9 0.9 0.9],'MarkerSize',40);
    ...
    if label==1
        if intersect(i,iAUDRANK)>0
        text('Position',[elec(i,1) elec(i,2) elec(i,3)],'String',AUDRANK(i),'Color','k','FontSize',24);
         text('Position',[elec(i,1)+7 (elec(i,2)+4) elec(i,3)],'String',AUDLATENCY(i),'Color','k','FontSize',24);
        end
    end
end
set(light,'Position',[-1 0 1]); 
