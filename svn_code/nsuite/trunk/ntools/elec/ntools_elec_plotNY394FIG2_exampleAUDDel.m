...
%     if i==8 || i==14 || i==15 || i==20 || i==21 || i==22 || i==24 || i==30 % AUD [8 14 15 20 21 22 24 30 32 53]; % AUD
%         elec(:,1)=elec(:,1)+30;
...
%     elseif  i==47  || i==54  % SM 37 43 47 48 % SM
%         elec(:,1)=elec(:,1)+10;
%         plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%         hold on;
...
%     elseif i==41 || i==43 || i==50 || i==59  % DEL 39 41 46
