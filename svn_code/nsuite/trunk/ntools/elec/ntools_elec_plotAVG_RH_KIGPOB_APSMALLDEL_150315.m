function ntools_elec_plotAVG_RH_KIGPOB_APSMALLDEL_150315
...
NYUMCDIR  = '/vol/sas5a/nim1';
%surf = '/mnt/raid/NYUMC/KP_First6Subjs/loc/KPFirst6Subj.rh.pial.mat';
surf = [NYUMCDIR '/KP_First6Subjs/loc/KPFirst6Subj.rh.pial.mat'];
% elseif nargin==2
...
load([NYUMCDIR '/KP_First6Subjs/ALLELECS_RH_WITHDELAY.mat']);
...
%          markblackdelay=70;
    ...
    marksize1=20; % 55
        ...
        PROD=[18,19,20,21,41,9+46,19+46,23+46,27+46,27+78,29+78,34+78,36+78,40+78,49+78,30+132];
        PRODd=[42+78];
        SM=[11,12,43+78,48+78,15+132,29+132,33+132];
     %   SM=[11,12];
        SMd=[22+46,37+78,47+78];
        DEL=[30,36,18+46,39+78,41+78,46+78,51+78,6+132];
...
DEL=cat(2,AUDd,PRODd,SMd,DEL);
AUDd=[];
PRODd=[];
SMd=[];
      %  DEL=184:189;
%         for i=1:length(AUD) % AUD
%             elec3=elec(AUD,:);
%             %     hold on;
%             %     plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize);
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%             hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize2);
%         end
        
%           for i=1:length(AUDd) % AUD delay
%             elec3=elec(AUDd,:);
%             elec3(:,1)=elec3(:,1)+90;
%             
%             %
...
%             %     plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize);
% 
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color','k','MarkerFaceColor',[147/255 112/255 219/255],'MarkerSize',markblackdelay);
%             hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize1);
%           end
        
%          for i=1:length(PROD) % PROD
%             elec3=elec(PROD,:);
%             
%             %
%             %     hold on;
...
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%             hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['b' 'o'],'MarkerFaceColor','b','MarkerSize',marksize2);
%         end
        
%           for i=1:length(PRODd) % PROD Delay
%             elec3=elec(PRODd,:);
%           elec3(:,1)=elec3(:,1)+150;
%           elec3(:,3)=elec3(:,3)+5;
%             %
...
%            plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color','k','MarkerFaceColor',[147/255 112/255 219/255],'MarkerSize',markblackdelay);
%            hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['b' 'o'],'MarkerFaceColor','b','MarkerSize',marksize1);
%           end
%         
%          for i=1:length(SM) % SM
%             elec3=elec(SM,:);
%              elec3(:,1)=elec3(:,1)+20;
%             
%             %
...
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%             hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize2);
%         end
        
%          for i=1:length(SMd) % SM Delay
%             elec3=elec(SMd,:);
%         elec3(:,1)=elec3(:,1)+20;
%             
%             %
...
%            plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color','k','MarkerFaceColor',[147/255 112/255 219/255],'MarkerSize',markblackdelay);
%            hold on;
%             plot3(elec3(i,1),elec3(i,2),elec3(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize1);
%          end
        
         for i=2:length(DEL) % DEL %NB: starts at 2
            elec3=elec(DEL,:);
             elec3(:,1)=elec3(:,1)+40;
	    elec3(:,2)=elec3(:,2)+20;
            ...
            plot3(elec3(i,1),elec3(i,2),elec3(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
            hold on;
            %plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color',[147/255 112/255 219/255],'MarkerFaceColor',[147/255 112/255 219/255],'MarkerSize',marksize2);
          % plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color',[1 140/255 0],'MarkerFaceColor',[1 140/255 0],'MarkerSize',marksize2);
          plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color','k','MarkerFaceColor',[0/255 51/255 102/255],'MarkerSize',markblackdelay);
           ax=gca;
           ax.Clipping='off';         
         end
    end
...
%    view(90,90);
%end
set(gcf, 'color','white','InvertHardCopy', 'off'); % used to be black
%axis tight;
axis equal;
