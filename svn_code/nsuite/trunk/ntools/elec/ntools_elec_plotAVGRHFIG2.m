function ntools_elec_plotAVGLHFIG2(elec2)
...
hold on
           plot3((elec(63,1)+10),elec(63,2),elec(63,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize); % SM
    for i=64:76 % SMA
        hold on
          plot3((elec(i,1)+10),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',7);
    end
