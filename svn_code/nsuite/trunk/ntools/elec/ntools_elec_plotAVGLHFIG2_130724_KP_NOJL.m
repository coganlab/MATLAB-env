 ...
 %   [FileName,PathName] = uigetfile('*.txt','Select the electrodes text file','/home/ccarlson/loc/');
  %  [surfname, surfpath] = uigetfile('*.mat','Select the patient brain surf',PathName,'MultiSelect','on');
   % surf = strcat(surfpath,surfname);    
    ...
    surf = '/mnt/raid/NYUMC/LHSUBJ_130724/loc/LH.AVG.lh.pial.mat';
% elseif nargin==2
...
% end
%load('/mnt/raid/NYUMC/LHSUBJ_130316/ALLELECS_LH.mat');
...
% for i=79:80 % SM
%     hold on;     
%     plot3((elec(37,1)-15),elec(37,2),elec(37,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize); % SM
% end

hold on;
   for i=[103:105,110:111] % SMA
      
       hold on;
    plot3((elec(i,1)-15),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
    hold on;
           plot3(elec(i,1)-15,elec(i,2),elec(i,3),['r' 'o'],'MarkerEdgeColor',[1 0.1 0.1],'MarkerFaceColor',[1 0.1 0.1],'MarkerSize',marksize);   
         %plot3((elec(i,1)-15),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',13);
   end
%    
end
