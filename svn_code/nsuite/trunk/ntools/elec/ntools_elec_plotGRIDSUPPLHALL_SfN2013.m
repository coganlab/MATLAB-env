...
sph='lh';
 surf = '/mnt/nim1/NYUMC/LHSUBJ_130724/loc/LH.AVG.lh.pial.mat';
...
filename=['/mnt/nim1/NYUMC/NY212/mri/transforms/talairach.xfm'];
...
elec_grid = elec_cell(g,:);
elecT=cell2mat(elec_grid(:,2:4));
filename=['/mnt/nim1/NYUMC/NY226/mri/transforms/talairach.xfm'];
fid=fopen(filename,'r');
gotit = 0;
string2match='Linear_Transform';
for i=1:20
...
% elec_grid = elec_cell(g,:);
% elecT=cell2mat(elec_grid(:,2:4));
% filename=['/mnt/nim1/NYUMC/NY332/mri/transforms/talairach.xfm'];
% fid=fopen(filename,'r');
% gotit = 0;
% string2match='Linear_Transform';
% for i=1:20
...
% elec_grid = elec_cell(g,:);
% elecT=cell2mat(elec_grid(:,2:4));
% filename=['/mnt/nim1/NYUMC/NY347/mri/transforms/talairach.xfm'];
% fid=fopen(filename,'r');
% gotit = 0;
% string2match='Linear_Transform';
% for i=1:20
...
% elec_grid = elec_cell(g,:);
% elecT=cell2mat(elec_grid(:,2:4));
% filename=['/mnt/nim1/NYUMC/NY351/mri/transforms/talairach.xfm'];
% fid=fopen(filename,'r');
% gotit = 0;
% string2match='Linear_Transform';
% for i=1:20
