...
nyumc;
load([NYUMCDIR '/NY311/mat/NY311PRODRANKS.mat']);
iPRODRANK=find(PRODRANK>0);
...
%     elseif i==14  ||i ==21 || i==22 || i==28 || i==50 || i==51 || i==56 || i==57 % AUD
       % plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize);
    if i==30 || i==32 || i==33 || i==34 || i==35 || i==37 || i==40 || i==41 || i==42 || i==43 || i==45 || i==46 || i==52 || i==53 || i==55 || i==60 || i==62  % PROD
...
%          plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0.9 0.9 0.9],'MarkerFaceColor',[0.9 0.9 0.9],'MarkerSize',40);
    ...
    if label==1
        if intersect(i,iPRODRANK)>0
        text('Position',[elec(i,1) elec(i,2) elec(i,3)],'String',PRODRANK(i),'Color','k','FontSize',24);
         text('Position',[elec(i,1)+7 (elec(i,2)+4) elec(i,3)],'String',PRODLATENCY(i),'Color','k','FontSize',16);
        end
    end
end
set(light,'Position',[-1 0 1]); 
