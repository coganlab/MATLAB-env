...
markblackSMA=80;
for i=1:length(elec)
    if i==2 || i==3 || i==4 || i==5 || i==6 || i==10 || i==11 || i==12 || i==13 || i==14 || i==15 || i==16 || i==18 || i==19 || i==20 || i==23 || i==24 || i==25 || i==26 || i==27 || i==28 || i==31 || i==32 || i==38 || i==40 ...
            || i==41 || i==42 || i==44 || i==45 || i==46 || i==56 || i==57 || i==59 || i==61% CF Delay LS
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
        plot3(elec(i,1),elec(i,2),elec(i,3),['m' 'o'],'MarkerFaceColor','m','MarkerSize',marksize);
%     elseif i==1 || i==15 || i==16 || i==22 || i==29 || i==30 || i==31 % PROD
%         plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
%         hold on;
