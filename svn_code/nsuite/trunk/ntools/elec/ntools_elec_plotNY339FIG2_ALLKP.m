...
for i=1:length(elec)
    ...
    elseif i==15 ||  i==22 || i==82 % PROD delay
            plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor',[147/255 112/255 219/255],'MarkerSize',markblackdelay);
             hold on;
   ...
   %     display(i) % removed bad channels
     ...
     elseif i==2 || i==101 || i==118 || i==127 % DEL
%      elseif i==2 || i==118 || i==127 % PREFRONT 2,118,127
       plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
