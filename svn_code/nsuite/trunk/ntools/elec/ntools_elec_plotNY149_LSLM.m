...
%         plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','g','MarkerSize',marksize);
   ...
   if i==20 || i==21 || i==22 || i==39 || i==41 || i==48 || i==55 || i==61
       plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
   ...
   elseif i==23 || i==27 || i==29 || i==35 || i==36 || i==37 || i==38 || i==45 || i==46 % PROD
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
