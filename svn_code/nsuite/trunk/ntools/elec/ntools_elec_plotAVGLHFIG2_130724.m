function ntools_elec_plotAVGLHFIG2_130724
...
% if nargin==0
 %   [FileName,PathName] = uigetfile('*.txt','Select the electrodes text file','/home/ccarlson/loc/');
  %  [surfname, surfpath] = uigetfile('*.mat','Select the patient brain surf',PathName,'MultiSelect','on');
   ...
   % surf = '/mnt/raid/NYUMC/LHSUBJ_130316/loc/LH.AVG.lh.pial.mat';
% /mnt/raid/nim1_backup/nim1-raid-backup/NYUMC/matlab/nyumc.m;
 %nyumc;
 NYUMCDIR = '/mnt/raid/nim1_backup/nim1-raid-backup/NYUMC';
    surf = [NYUMCDIR '/LHSUBJ_130724/loc/LH.AVG.lh.pial.mat'];
% elseif nargin==2
...
% end
%load('/mnt/raid/NYUMC/LHSUBJ_130724/ALLELECS_LH.mat');
load([NYUMCDIR '/LHSUBJ_130724/ALLELECS_LH.mat']);
...
for i=27:83 % PROD
  ...
  hold on 
          plot3(elec(i,1),elec(i,2),elec(i,3),['b' 'o'],'MarkerEdgeColor',[0.1 0.1 1],'MarkerFaceColor',[0.1 0.1 1],'MarkerSize',marksize);
