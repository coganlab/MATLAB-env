function ntools_elec_plotAVG_LH_KIGPOB_APSMALLDEL_150315
...
surf = [NYUMCDIR  '/KP_First6Subjs/loc/KPFirst6Subj.lh.pial.mat'];
% elseif nargin==2
...
% end
load([NYUMCDIR '/KP_First6Subjs/ALLELECS_LH_WITHDELAY.mat']);
...
%         AUD=[33+64 39+64];
%         AUDd=[19 23+64];
%         PROD=[8,11,53 9+64,12+64,24+64,25+64];
%         PRODd=[7,12,42,6+64,113,115];
%         SM=[14,20];
%         SMd=[34+64,35+64,41+64];
%       %  DEL=[111:112,114,116:118,119];
%         DEL=[111,112,118]; % PREFRONT
AUD=[19,33+64,39+64];
PROD=[8,11,53,9+64,12+64,24+64,25+64];
SM=[14,20];
AUDd=[19,23+64];
...
SMd=[];
        ...
        for i=1:length(DEL) % DEL
         ...
         % plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color',[1 140/255 0],'MarkerFaceColor',[1 140/255 0],'MarkerSize',marksize2);
          plot3(elec3(i,1),elec3(i,2),elec3(i,3),'o','Color',[0 51/255 102/255],'MarkerFaceColor',[0 51/255 102/255],'MarkerSize',marksize2);

            %   plot3(elec3(i,1),elec3(i,2),elec3(i,3),['m' 'o'],'MarkerFaceColor','m','MarkerSize',marksize1);
        end
