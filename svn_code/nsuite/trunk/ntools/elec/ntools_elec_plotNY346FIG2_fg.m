...
markblackdelay=20;
for i=1:length(elec)
    if i==13 || i==15 || i==20 % AUD 20=aud delay
...
%         plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',13);
        plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
        plot3(elec(i,1),elec(i,2),elec(i,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize);
    elseif i==48  % DEL
    ...
    elseif i==1 || i==7 || i==8 || i==9 || i==10 || i==11 || i==16 || i==17 || i==18 || i==19 || i==25 || i==26 || i==55 || i==56 || i==61 || i==62 || i==63 || i==64
        display(i)
    else
