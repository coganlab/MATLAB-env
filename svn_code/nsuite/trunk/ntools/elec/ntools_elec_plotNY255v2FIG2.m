...
for i=1:length(elec)
    ...
    elseif i==24 || i==36 || i==40 || i==44 || i==45 || i==46 || i==55 || i==60 || i==62 || i==63 % PROD
          plot3(elec(i,1),elec(i,2),elec(i,3),['k' 'o'],'MarkerFaceColor','k','MarkerSize',markblack);
        hold on;
  ...
  elseif i==1 || i ==2 || i==16 || i ==27 || i==33 || i==34 || i ==35 || i==50 || i==51 || i==52 || i==53
        display(i)    
    else
