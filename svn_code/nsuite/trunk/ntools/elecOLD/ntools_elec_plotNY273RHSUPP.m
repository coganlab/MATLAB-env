...
%                    plot3(elec(i,1),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',7);
   ...
   if i==49 ||i ==50 || i==51 || i==52 || i==53 || i==54 || i==55 ||i==56 ||i==57 || i==58  || i==67 || i ==68 || i==97 || i==98
    %plot3(elec(i,1),elec(i,2),elec(i,3),[color 'o'],'MarkerFaceColor',color,'MarkerSize',marksize);
                 plot3(elec(i,1),elec(i,2),elec(i,3),'o','MarkerEdgeColor',[0 0 0],'MarkerFaceColor',[0 0 0],'MarkerSize',40);
    else 
        display(i)
    end
    if label==1
