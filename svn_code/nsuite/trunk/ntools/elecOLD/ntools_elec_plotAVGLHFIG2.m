...
hold on
           plot3((elec(37,1)-5),elec(37,2),elec(37,3),['r' 'o'],'MarkerFaceColor','r','MarkerSize',marksize); % SM
    for i=38:49 % SMA
        hold on
          plot3((elec(i,1)-5),elec(i,2),elec(i,3),['g' 'o'],'MarkerFaceColor','r','MarkerSize',marksize,'LineWidth',7);
    end
